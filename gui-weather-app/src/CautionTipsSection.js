...
function Caution({weatherData}, {city}) {
  ...
  const printTips = (temp) => {
    ...
    if (temp <= 5){
      ...
      return <div className="tips-writing">
        <p>1) Layer Up: Dress with insulating mid-layers, and a waterproof outer shell to stay warm and dry.</p>
        <p>2) Insulate Extremities: Wear gloves, a hat, and thick socks to protect your hands, head, and feet from frostbite.</p>
        <p>3) Stay Hydrated: Even in cold weather, dehydration is a risk. Drink plenty of water and warm beverages.</p>
        <p>4) Watch for Ice: Be cautious of icy patches on trails.</p>
      </div>
    } else if (temp > 5 && temp <= 15){
      console.log("between 5 and 15");
      return <div className="tips-writing">
        <p>1) Dress in Layers: Opt for breathable clothing that can be easily adjusted as you warm up during the hike.</p>
        <p>2) Sun Protection: Apply sunscreen and wear sunglasses to shield yourself from UV rays, even on overcast days.</p>
        <p>3) Hydration and Snacks: Bring water and energy-rich snacks to maintain energy levels throughout the hike.</p>
        <p>4) Pace Yourself: Take breaks as needed to prevent overheating.</p>
      </div>
    } else if (temp > 15 && temp <= 25){
      console.log("between 15 and 25");
      return <div className="tips-writing">
        <p>1) Hydration: Drink plenty of water before, during, and after the hike to prevent dehydration.</p>
        <p>2) Sun Safety: Wear a wide-brimmed hat, lightweight clothing with UPF protection, and reapply sunscreen regularly.</p>
        <p>3) Plan for Shade: Choose trails with ample shade.</p>
        <p>4) Time Your Hike: Opt for early morning or late afternoon hikes to avoid the peak heat of the day.</p>
      </div>
    } else if (temp > 25 && temp <=35){
      console.log("between 25 and 35");
      return <div className="tips-writing">
        <p>1) Hydration Strategy: Drink water consistently.</p>
        <p>2) Cool Off: Take breaks in shaded areas or near water sources to cool down.</p>
        <p>3) Lightweight Clothing: Choose breathable fabrics that allow for airflow and quick drying.</p>
        <p>4) Know Your Limits: Be prepared to shorten or postpone your hike if conditions become too extreme.</p>
      </div>
    }else {
      console.log("above 35");
      return <div className="tips-writing">
        <p>1) Hydration: Drink water consistently and consider electrolyte supplements to replace lost minerals through sweat.</p>
        <p>2) Cooling Breaks: Take breaks in shaded areas or near water sources to cool down.</p>
        <p>3) Lightweight Gear: Choose moisture-wicking, breathable fabrics for airflow and quick drying.</p>
